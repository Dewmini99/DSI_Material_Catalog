        ...
        if (!err) {
            if (results.length <= 0) {
                ...
                var mailOptions = {
                    ...
                    to: results[0].email,
                    subject: 'Password by Material Catalog',
                    html: '<p><b>Tour Login Details for Material Catalog</b><br><b>Email:</b>' + results[0].email + '<br><b>Password: </b>' + results[0].password + '<br><a href="http://localhost:4200/">Click here to login</a></p>'
                };
